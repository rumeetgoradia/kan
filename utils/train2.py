...
from network.kan_bspline import BSplineKAN
import numpy as np
...
def train_and_validate(epochs=15):
    ...
    trainset = torch.from_numpy(np.load('../data/prepared/sequenced/X_train.npy'))
